...
isGetDataToMat3=1;%0不更新all2.mat中数据，1再次更新all2.mat中的数据 ，在没有新数据的情况下只要在第一次使用时赋1,默认为0
...
getFingerprint3(isGetFingerprint ,wipeOutData,fan,hairdryer,kettle,mipad,pc )
